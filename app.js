...
const groups = [{
    ...
    },
    {
        ...
        "spellingPractice": {
            "words": ["in", "pin", "nip", "pit", "sit", "sat", "spin", "snap", "pant", "span"]
        },
        "nextGroupId": 3
    },
    {
  ...
  "letters": ["r", "m", "d"],
  "songs": [
    { "letter": "r", "label": "R 歌曲", "audio": "audio/r-song.mp3" },
    { "letter": "m", "label": "M 歌曲", "audio": "audio/m-song.mp3" },
    { "letter": "d", "label": "D 歌曲", "audio": "audio/d-song.mp3" }
  ],
  "phonics": [
    {
      "letter": "r",
  ...
  "cards": [
    { "letter": "r", "label": "R /r/", "draggable": true },
    { "letter": "m", "label": "M /m/", "draggable": true },
    { "letter": "d", "label": "D /d/", "draggable": true }
  ],
  "images": [
...
},
{
  ...
  "letters": ["g", "o", "u"],
  "songs": [
    { "letter": "g", "label": "G 歌曲", "audio": "audio/g-song.mp3" },
    { "letter": "o", "label": "O 歌曲", "audio": "audio/o-song.mp3" },
    { "letter": "u", "label": "U 歌曲", "audio": "audio/u-song.mp3" }
  ],
  "phonics": [
    {
      "letter": "g",
  ...
  "cards": [
    { "letter": "g", "label": "G /g/", "draggable": true },
    { "letter": "o", "label": "O /ɒ/", "draggable": true },
    { "letter": "u", "label": "U /ʌ/", "draggable": true }
  ],
  "images": [
    { "letter": "g", "word": "Goat" },
    ...
    switch (letter) {
       ...
       <svg class="phonics-image" xmlns="http://www.w3.org/2000/svg"
        ...
        case "t":
            return `
        <svg class="phonics-image" xmlns="http://www.w3.org/2000/svg"
                                    viewbox="0 0 250.91 295.24">
                                    <defs />
                                    <path class="cls-10"
                                        d="M74.78 35.36c.64 1.76 6.94 2.12 6.47 4.39-.55 2.64-10.02-.52-10.85-.23-.98.34-1.02 2.78 0 3.23.66.29 5.24.19 6.47.46 2.39.54 16.69 3.35 15.01 7.16-3.01 3.14-20.26-4.34-21.48-3.46-.25.78-.44 4.51-.23 4.85.37.61 11.26 1.62 14.09 2.54 1.17.38 15.75 6.8 12.47 8.78-5.12.87-9.25-2.73-13.62-4.16-4.05-1.33-7.94-2.74-12.24-3.23-.35 14.76-5.66 14.44-6.93.46-4.78-.75-8.89 1.86-13.16 3.23-1.74.56-12.56 5.91-13.39 3-.59-2.06 15.39-9.37 17.78-9.93 1.44-.34 8.74-.32 9.01-.69.16-.22.26-4.52-.69-4.85-1.94-.66-17.37 6.72-21.01 3.46-1.97-4.66 17.96-7.8 21.01-7.62 3.37-5.36-7.25-.95-9.93-2.54-1.18-1.41 5.6-4.14 6.47-4.39 1.26-.36 2.08-.3 3.23-.46 4.07-.58 7.51-.46 11.55 0Z"
                                        style="fill: #a54c1f;" />
                                    <path class="cls-4"
                                        d="M92.33 150.82c-3.4 19.02-13.6 31.01-18.47 48.72-1.38 5.03-2.19 10.36-3.23 15.47-1.09-.44-4.32-.76-5.77-1.39-9.29-4.03-18.51-9.37-23.32-18.7l-.92 1.62c-.35-.73-1.03-2.11-1.39-2.77l-2.31-36.49c.44-1.84.8-2.55 1.39-4.16 2.41 3.7 15.33 3.37 16.86 4.62 1.02.83.13 3.53 2.31 4.62 6.42 3.22 28.78-7.4 34.87-11.55Z"
                                        style="fill: #f7d5a3;" />
                                    <path class="cls
                                        style="fill: #853215;" />
                                    <path class="cls-17"
                                        d="M209.17 52.45c.02 2.02.18 4.02.46 6l-12.93-3.23c4.07-1.46 8.06-3.31 12.47-2.77"
                                        style="fill: #e88a18;" />
                                    <path class="cls-12"
                                        d="M216.1 162.83c.34.59.6 1.24.92 1.85-2.91 3.55-5.65 7.22-9.24 10.16-.03-.04-.73-.01-.46-.92 7.32-4.07-1.51-8.08-4.62-11.55 1.98-2.35 3.99-5.19 5.54-7.85 3.71 1.22 6.03 5.2 7.85 8.31Zm14.78-54.04c-1.14.62-2.23 2.06-3.23 2.77-4 2.81-8.93 4.93-13.39 6.93-.36-1.8-.86-3.79-1.39-5.54 6.03-1.09 10.43-5.47 13.86-10.16.15-.21 1.1-.89 1.39-1.39 1.16 2.72 1.86 4.56 2.77 7.39Z"
                                        style="fill: #853215;" />
                                    <path class="cls-17"
                                        d="M234.11 129.57c-2 .06-3.87.67-6 .92l-.46-18.94c1.01-.71 2.1-2.15 3.23-2.77 2.57 8.02 3.84 11.98 3.23 20.78Zm-.46 3.24c-.85 6.08-2.87 10.35-5.54 15.7-1.45.21-3.18.16-4.62 0l3.69-14.78c2.18-.27 4.24-1.03 6.47-.92"
                                        style="fill: #e88a18;" />
                                    <path class="cls-12"
                                        d="M223.49 148.51c1.44.16 3.17.21 4.62 0-.78 1.57-1.58 2.44-2.31 3.69-1.21-.08-2.49.12-3.69 0-3.1-.3-7.87-1.64-10.62-3.23.24-.55.63-1.96.92-2.77 3.69.67 7.35 1.89 11.08 2.31m10.62-18.94c-.06.85-.33 2.26-.46 3.23-2.23-.1-4.28.66-6.47.92-4 .49-8.02.33-12.01.92.13-1.26.44-2.33.46-3.69 4.21.13 8.28.03 12.47-.46 2.13-.25 4-.87 6-.92Z"
                                        style="fill: #853215;" />
                                    <path class="cls-17"
                                        d="M225.8 152.2c-2.74 4.71-5.34 8.27-8.78 12.47-.32-.6-.58-1.26-.92-1.85l6-10.62c1.21.12 2.48-.08 3.69 0Z"
                                        style="fill: #e88a18;" />
                                    <path class="cls-6"
                                        d="m227.65 111.56.46 18.94c-4.19.49-8.26.59-12.47.46.05-3.52-.68-8.97-1.39-12.47 4.47-1.99 9.39-4.12 13.39-6.93Zm-.46 22.17-3.69 14.78c-3.73-.42-7.4-1.64-11.08-2.31 1.35-3.68 2.35-7.63 2.77-11.55 3.98-.59 8.01-.43 12.01-.92Zm-5.08 18.47-6 10.62c-1.82-3.11-4.14-7.09-7.85-8.31.76-1.3 2.77-4.46 3.23-5.54 2.75 1.59 7.52 2.94 10.62 3.23"
                                        style="fill: #f9ad1e;" />
                                    <path class="cls-17"
                                        d="m207.33 173.91-.69.46-7.62-7.85c.42-.25 3.11-3.47 3.69-4.16 3.11 3.46 11.93 7.47 4.62 11.55"
                                        style="fill: #e88a18;" />
                                    <path class="cls-10"
                                        d="M198.09 166.52c-.12 1.87 1.58 13.97-.69 13.86l-5.77-18.01c2.27 1.24 4.48 2.48 6.47 4.16Z"
                                        style="fill: #a54c1f;" />
                                    <path class="cls
 1.22-.88 18.47 6.61 21.48 3.46 1.68-3.81-12.62-6.62-15.01-7.16-1.22-.27-5.81-.17-6.47-.46-1.02-.45-.98-2.9 0-3.23.83-.29 10.31 2.87 10.85.23.47-2.27-5.83-2.63-6.47-4.39 7.58.87 14.49 3.54 21.01 7.39 1.02-3.88 1.68-7.91 3.46-11.55 8.14-16.58 29.56-8.8 33.71 4.62Z"
                                        style="fill: #f9ad1e;" />
                                    <path class="cls-18"
                                        d="M109.65 33.05c8.47-1.86 17.49 6.99 12.24 15.47-1 1.62-8.85 7.66-10.39 7.62-.62-.01-8.82-7.95-9.01-8.54-1.23-3.82 2.95-13.62 7.16-14.55"
                                        style="fill: #fee8cb;" />
                                    <path class="cls-5"
                                        d="M88.4 79.69c10.64-2.55 11.44 17.57 2.77 18.94-9.17 1.45-10.58-17.06-2.77-18.94"
                                        style="fill: #633a29;" />
                                    <path class="cls-10"
                                        d="M89.33 66.3c2.56-.43 9.45.75 9.93 3.93.95 6.26-14.71 2.88-13.86-1.39.86-1.05 2.63-2.32 3.93-2.54"
                                        style="fill: #a54c1f;" />
                                    <path class="cls-9"
                                        d="M70.62 215.01c.06.02-.18.76.23.92 1.66.67 8.27 1.81 9.01 3 .8 1.31.57 10.08.92 12.24-2.99-.39-5.78-1.29-8.78-1.39-.31-1.03-11.71-6.32-13.86-7.85-10-7.15-12.55-15.02-17.55-25.4l.92-1.62c4.82 9.34 14.03 14.68 23.32 18.7 1.45.63 4.68.95 5.77 1.39Z"
                                        style="fill: #e3b884;" />
                                    <path class="cls-3"
                                        d="M39.22 193.77c.36.66 1.04 2.04 1.39 2.77 5 10.38 7.55 18.25 17.55 25.4-.92 4.02 12.62 11.38 12.93 12.24s-.38 3.73-1.39 4.39c-3.37 1.12-6.76 3.2-10.16 4.39l11.55.69c-.28 5.56-.95 11.09-1.39 16.63l-13.39 5.77c-.69 4.21 11.89-2.48 13.39-2.08-.12 1.41-.33 2.77-.46 4.16-.25 2.72-.15 5.58-.46 8.31-.38 3.32-.57 7.47-1.39 10.62-2.25-4.89-11.26-7.02-16.16-6.93v-.92c0-2.55-1.04-6.14-1.39-8.78-.66-5.06-1.21-10.18-1.85-15.24l12.93-4.39c0-1.71-12.01 1.07-13.39.23-.56-4.33-.75-9.18-1.39-13.39 4.52.5 9.69.71 13.86-1.62l-14.78-3.46c-2.08-13.28-5.19-26.44-7.39-39.72.62-.21 1.2.57 1.39.92Z"
                                        style="fill: #f0781a;" />
                                    <path class="cls-10"
                                        d="M46.14 237.65c-.25-1.66-.66-3.42-.92-5.08L60 236.03c-4.17 2.32-9.34 2.11-13.86 1.62m1.85 17.55c-.17-1.38-.28-2.77-.46-4.16 1.38.84 13.39-1.94 13.39-.23z"
                                        style="fill: #a54c1f;" />
                                    <path
                                        d="M72.01 229.79c-.07 2.94-.34 5.84-.46 8.78-.56.09-1.41-.15-1.85 0 1-.66 1.7-3.52 1.39-4.39s-13.85-8.22-12.93-12.24c2.15 1.54 13.55 6.82 13.86 7.85Z"
                                        style="fill:#e06518" />
                                    <path class="cls-10"
                                        d="M69.7 260.28c-.1 1.21.11 2.48 0 3.69-1.5-.4-14.08 6.29-13.39 2.08z"
                                        style="fill: #a54c1f;" />
                                    <path
                                        d="M71.54 238.57c-.07 1.62-.38 3.38-.46 5.08l-11.55-.69c3.4-1.19 6.79-3.27 10.16-4.39.44-.15 1.29.09 1.85 0"
                                        style="fill:#b9541b" />
                                    <path class="cls-17"
                                        d="M104.34 137.89c-2.98 4.76-6.64 10.12-12.01 12.47.49-2.89.55-5.87.92-8.78 3.38-.74 7.47-3.03 11.08-3.69Z"
                                        style="fill: #e88a18;" />
                                    <path class="cls-3"
                                        d="M173.61 233.03c-4.69.97-10.85 3.67-15.24 5.77 2.84.75 6.02-.75 9.01-.69s4.56 1.86 8.08.92c1.32 2.88 3.14 5.52 4.62 8.31-4.21 4.52-7.74 6.04-13.86 6.7-.92 2.55 10.15 3.41 12.01 1.62-1.41 4.47-3.15 8.67-5.08 12.93-.93 2.04-1.68 4.54-2.77 6.47s-2.74 4.34-4.62 5.54c-.05-7.08-7.85-10.69-14.32-10.16.76-1.27.44-2.77.46-4.16.06-4.73.71-10.28.46-14.78.92-.6 11.89-3.24 10.16-5.31-3.45-.31-6.93-.45-10.39-.69-.37-.03-.18.93-.23.92-6.5-.48-10.18-4.95-9.24-11.55 9.78-.34 20.12-1.46 29.1-5.54.14.67 1.28 3.05 1.85 3.69Z"
                                        style="fill: #f0781a;" />
                                    <path class="cls-10"
                                        d="M175.46 239.03c-3.52.94-5.09-.87-8.08-.92s-6.17 1.44-9.01.69c4.39-2.11 10.55-4.81 15.24-5.77 2.19-.45 13.16-1.99 13.39 1.62.12 1.88-4.69.98-6.7 1.62-1.24.4-3.91 2.52-4.85 2.77Z"
                                        style="fill: #a54c1f;" />
                                    <path class="cls-4"
                                        d="M171.77 223.33c.02 1.87-.38 4.13 0 6-8.98 4.08-19.31 5.2-29.1 5.54-7.09.25-14.6-.51-21.71-.92-1.15-3.72-2.91-7.24-3.69-11.08 17.98.51 36.26 3.49 54.04-.92-.08 1.38.46 1.31.46 1.39Z"
                                        style="fill: #f7d5a3;" />
                                    <path class="cls-9"
                                        d="M113.11 222.4c1.41-.42 3.02.43 4.16.46.79 3.85 2.55 7.37 3.69 11.08-3.71-.22-7.43-.11-11.08-.92.43-2.23.45-9.8 3.23-10.62"
                                        style="fill: #e3b884;" />
                                    <path class="cls-10"
                                        d="M180.54 248.27c-1.26 2.29-1.54 4.95-2.31 7.39-1.86 1.79-12.93.94-12.01-1.62 6.11-.66 9.65-2.17 13.86-6.7.14.27.32.64.46.92Z"
                                        style="fill: #a54c1f;" />
                                    <path class="cls-6"
                                        d="M106.18 137.42c.46.16 2.83 2.7 3.69 3.23-5.66 10.33-10.62 23.9-18.01 33.02-1.71 2.11-10.21 9.1-10.62 10.16-.27.68-.7 2.06.23 2.54 6.35 1.98 25.88-23.22 29.33-28.4 2.67-4.01 5.13-8.21 6.93-12.7 1.01.44 2.22 1.02 3.23 1.39-2.46 11.9-5.61 26.3-11.08 37.18-.44.88-5.38 6.24-3.93 7.16 1.84-.22 3.64-2.5 4.85-3.93 8.57-10.13 15.8-25.46 18.01-38.56 1.71.5 3
1.71-9.13-1.85-13.86l14.78-1.15c.33-1.76-13.94-1.97-14.78-2.08-.03 0 .16-.38-.46-.46-.35-2.16-.12-10.93-.92-12.24-.73-1.19-7.34-2.33-9.01-3-.42-.17-.17-.9-.23-.92 1.04-5.11 1.85-10.45 3.23-15.47 4.88-17.71 15.07-29.71 18.47-48.72.03-.15-.03-.31 0-.46 5.37-2.35 9.02-7.71 12.01-12.47.18-.03.36-1 1.85-.46Z"
                                        style="fill: #f9ad1e;" />
                                    <path class="cls-10"
                                        d="M214.26 234.41c-.31 2.9-.98 6.23-1.39 9.24l-20.78 2.54zm-4.16 29.56c-1.11-.37-9.2-1.4-8.78-3 4.9-1.13 7.76-1.79 10.62-6.23-.51 3.41-.93 5.89-1.85 9.24Zm-24.48-104.38.23 23.09c-.85-8.88-2.11-17.44-7.16-24.94 2.29.56 4.7 1.07 6.93 1.85M80.09 213.63c1.23-.88 20.41 3.48 22.4 6.23-.38 2.57-21.93-.51-22.63-1.85-.16-.3-.06-4.18.23-4.39Zm91.68 9.7c0-.07-.54 0-.46-1.39.07-1.26-.48-3.83.69-4.62 7.31-.26 12.86-4.73 19.17-7.62-5.24 5.83-11.87 11.06-19.4 13.62Zm-62.35 12.01c-.32 1.85-.64 3.68-.92 5.54-4.32-.83-9.86 1.64-13.39-1.62l14.32-3.93Zm75.74 24.47c-.15-.84-1.06-3.49-1.39-4.62 4.24-.98 8.51-2.95 12.93-2.08.97 1.19-10.7 5.4-11.55 6.7Zm-78.51-4.61c-.15 1.08-.31 2.16-.46 3.23-20.38 7.46-14.3-.5.46-3.23m-23.56-2.31c-.14-1.51.07-3.34 0-4.16 1.29-.11 17.85-2.4 15.24.69-.51.6-13.13.82-15.24 3.46Z"
                                        style="fill: #a54c1f;" />
                                    <path class="cls-17"
                                        d="M117.27 222.87c-1.14-.03-2.74-.88-4.16-.46-1-.65-.68-1.54-.46-2.54.52-2.36 2.26-6.34 3.46-8.54.87 3.58.44 8.07 1.15 11.55Z"
                                        style="fill: #e88a18;" />
                                    <path class="cls-10"
                                        d="M81.24 234.87c-.03-1.07.02-2.16 0-3.23.83.11 15.11.32 14.78 2.08z"
                                        style="fill: #a54c1f;" />
                                    <path class="cls-4"
                                        d="M165.76 280.6c.06 8.15-8.75 4.79-13.86 4.16l-.23-6.47c-1.38 1.65-1.58 4.48-.69 6.47-2.83-.42-3.29-.52-6-1.39l.23-6.47c-2.07 1.74-1.69 4.12-1.15 6.47-7.15-2.56-6.6-4.99-.46-9.24 1.61-1.11 6.18-3.56 7.85-3.69 6.47-.53 14.26 3.08 14.32 10.16Z"
                                        style="fill: #f7d5a3;" />
                                    <path class="cls-7"
                                        d="M151.91 284.75c-.3-.04-.63.04-.92 0-.89-1.99-.69-4.82.69-6.47zm-6.93-1.38c-.24-.08-.7.08-.92 0-.54-2.34-.92-4.72 1.15-6.47z"
                                        style="fill: #764024;" />
                                    <path class="cls-4"
                                        d="M67.39 287.06c-.14.53-.37 2.85-.46 3-1.74 2.91-13.31 2.18-16.63 2.08l.69-5.08c-1.87-1.58-1.66 3.7-1.62 5.08-2.29-.12-4.16-.07-6.47-.46l1.15-7.39c-1.6 2.1-2.24 4.85-2.08 7.39-5.03-1.11-5.49-2.61-1.85-7.16 2.34-2.92 7.48-4.32 11.08-4.39 4.91-.09 13.91 2.03 16.16 6.93Z"
                                        style="fill: #f7d5a3;" />
                                    <path d="M42.91 291.68c-.29-.05-.65.06-.92 0-.17-2.54.48-5.29 2.08-7.39l-1.15 7.39Z"
                                        style="fill:#834e27" />
                                    <path class="cls-7"
                                        d="M50.3 292.14c-.3 0-.62.02-.92 0-.04-1.38-.26-6.66 1.62-5.08l-.69 5.08Z"
                                        style="fill: #764024;" />
                                    <path class="cls-4"
                                        d="M199.94 286.6c4.02 9.75-10.62 9.31-15.24 6.93l.46-5.31c-1.8-2.09-1.56 3.65-1.39 4.39-1.44 1.78-4.6-.38-6-.92l-.23-6.93c-1.73 2.33-1.04 4.29-.69 6.93-.92-.4-3.23-.56-3.69-2.08-1.28-4.13 6.5-11.04 10.16-11.78.44-.09 2.19-.46 2.31-.46 4.66.08 12.52 4.86 14.32 9.24Z"
                                        style="fill: #f7d5a3;" />
                                    <path class="cls-7"
                                        d="M177.77 291.68c-.22-.08-.73.09-.92 0-.34-2.64-1.03-4.6.69-6.93zm6.93 1.85c-.71-.36-.58.51-.92-.92-.18-.74-.42-6.48 1.39-4.39l-.46 5.31Z"
                                        style="fill: #764024;" />
                                    <path class="cls-4"
                                        d="M102.03 288.91c-.21 1.06.29 3.09 0 3.93-1.14 3.33-12.57 2.3-15.7 2.08l.23-6c-1.32 1.6-1.6 4.09-.69 6-2.97-.25-3.85-.72-6.47-1.39l.69-6.93c-2.33 1.53-1.73 4.44-1.62 6.93-3.22-.92-7.72-.36-4.62-5.77 1.3-2.27 9.18-5.22 11.55-5.31 4.74-.18 12.93 3.39 16.63 6.47Z"
                                        style="fill: #f7d5a3;" />
                                    <path class="cls-7"
                                        d="M79.4 293.53c-.26-.07-.68.07-.92 0-.12-2.49-.72-5.4 1.62-6.93l-.69 6.93Z"
                                        style="fill: #764024;" />
                                    <path class="cls-12" d="M86.32 294.91c-.15-.01-.31.01-.46 0-.91-1.91-.62-4.4.69-6z"
                                        style="fill: #853215;" />
                                    <path class="cls-18"
                                        d="M81.71 101.86c8.9 2.23 18.48 9.2 17.55 19.4-2.45 26.93-62.67 26.17-63.73-.92-.4-10.19 8.58-15.51 17.09-18.01.66-.19 1.17-.31 1.85-.46-3.3 5.3 2.78 8.87 6.7 11.08 3.27 1.85 6.98-.09 5.77 5.77-1.73 8.4-20.78 8.05-17.09-2.31-5.18-2.05-.79 6.14 1.62 7.62 3.41 2.1 8.48 1.83 12.01 0 1.14-.59 3.73-3.77 4.16-3.69 1.29.24 4.41 6.32 12.01 5.08 5.31-.86 9.5-10.15 6.47-9.7.2 10.83-16.54 11.28-18.24 3-1.2-5.84 2.75-3.97 6.23-5.77 4.76-2.46 10.17-6.61 4.39-11.55 1.07.11 2.18.2 3.23.46Z"
                                        style="fill: #fee8cb;" />
                                    <path class="cls-15" d="M53.3 117.1c.34-.25 1.49.03 1.15.69-.36.72-2.15.03-1.15-.69"
                                        style="fill: #591e16;" />
                                    <path class="cls-12"
                                        d="M82.86 111.56c.39-.23 1.18.63 1.15.69-.35.77-2.19-.07-1.15-.69"
                                        style="fill: #853215;" />
                                    <path class="cls-15" d="M81.94 114.33c.7-.25 1.02.68.46.92-.68.3-1.02-.72-.46-.92"
                                        style="fill: #591e16;" />
                                    <path class="cls-11" d="M52.38 113.87c.7-.25 1.02.68.46.92-.68.3-1.02-.72-.46-.92"
                                        style="fill: #703020;" />
                                    <path class="cls-5"
                                        d="M75.01 116.64c.7-.25 1.02.68.46.92-.68.3-1.02-.72-.46-.92m-18.94 2.77.7.23-.7.7-.23-.23z"
                                        style="fill: #633a29;" />
                                    <path class="cls-11" d="m78.24 118.95.46.46v.46h-.46z" style="fill: #703020;" />
                                    <path class="cls-15"
                                        d="m50.53 118.95.69.23-.23.69-.23-.23zm31.87-.46.69.23-.69.69-.23-.23zm-3.7-2.31.23.69-.69.23-.23-.23z"
                                        style="fill: #591e16;" />
                                    <path style="fill:#310500" d="m57 116.18.69.23-.69.69-.23-.23z" />
                                    <path style="fill:#460400" d="m51.45 111.56.7.23-.7.7-.23-.24z" />
                                    <path class="cls-10"
                                        d="M152.37 251.5c-.09-1.64-.8-3.3-.46-5.08.05 0-.14-.95.23-.92 3.46.24 6.94.38 10.39.69 1.73 2.07-9.24 4.71-10.16 5.31"
                                        style="fill: #a54c1f;" />
                                    <path class="cls-14"
                                        d="M78.47 101.4c5.79 4.94.37 9.08-4.39 11.55-3.49 1.81-7.44-.07-6.23 5.77 1.7 8.28 18.44 7.83 18.24-3 3.03-.45-1.15 8.84-6.47 9.7-7.6 1.24-10.72-4.84-12.01-5.08-.43-.08-3.02 3.1-4.16 3.69-3.53 1.83-8.6 2.1-12.01 0-2.4-1.48-6.79-9.67-1.62-7.62-3.7 10.36 15.36 10.71 17.09 2.31 1.21-5.86-2.51-3.92-5.77-5.77-3.92-2.22-10-5.78-6.7-11.08 9.42-2.12 8.66 1.5 13.16 1.39 2.84-.07 4.05-2.53 10.85-1.85Z"
                                        style="fill: #4e2c2e;" />
                                    <path class="cls-14"
                                        d="M59.77 103.25c1.93-.48 12.26 2.21 15.7.46 3.63 6.08-13.33 3.64-15.7 1.85-.99-.75-1.46-1.94 0-2.31"
                                        style="fill: #4e2c2e;" />
                                </svg>`;
        default:
            return "";
...
function renderGroup(id) {
    ...
    songSection.className = "bg-light p-4 rounded-3 mb-4";
  ...
  `;
    ...
    group.songs.forEach(song => {
        ...
        button.className = `btn btn-outline-primary text-center d-flex flex-column align-items-center justify-content-center p-3 rounded-3 shadow-sm`;
        button.innerHTML = `
...
phonicsSection.innerHTML = `
  <h2 class="fs-1 fw-bold text-indigo mb-5 d-flex align-items-center border-bottom border-indigo-light pb-3">
...
group.phonics.forEach(p => {
  ...
  card.className = "rounded-3 p-4 d-flex flex-column align-items-center shadow w-100 h-100";
  ...
  face.innerHTML = `
    ...
    <strong class="fs-2 text-secondary">${p.ipa}</strong>
  `;

  const button = document.createElement("button");
  button.className = "btn w-100 d-flex align-items-center justify-content-center text-white fs-5";
  ...
  mouthHint.innerHTML = `
    <p class="fs-4 text-secondary">嘴型提示：</p>
    <p class="fs-5 text-secondary">${p.hint}</p>
  `;
...
content.appendChild(phonicsSection);
    ...
    matchSection.className = "bg-light p-4 rounded-3 mb-4";
    matchSection.innerHTML = `<h2 class="h4 mt-4 mb-3">字母配對遊戲</h2>
        <p class="mb-4 text-secondary">點擊左側字母卡，再點右側對應的圖片卡進行配對！</p>`;
    ...
    leftCol.className = "col-12 col-md-5 d-flex flex-column gap-3 align-items-center";
    ...
    centerCol.setAttribute("aria-hidden", "true"); // 純裝飾
    ...
    rightCol.className = "col-12 col-md-5 d-flex flex-column gap-3 align-items-center";
    ...
    let selectedLetterElem = null;
    let matchedLetters = new Set();
    let lines = []; // [{from:HTMLElement, to:HTMLElement, letter:string}]
    let focusLine = null;
    ...
    shuffledCards.forEach((c, idx) => {
        ...
        card.className = "border rounded p-3 bg-white text-center fw-bold fs-4 shadow-sm letter-match-card";
        ...
        card.addEventListener("click", () => {
            ...
            // 取消前一個選擇
            if (selectedLetterElem) selectedLetterElem.classList.remove("border-primary", "bg-primary", "text-white");
            // 設定新選擇
            selectedLetter = c.letter;
            selectedLetterElem = card;
            card.classList.add("border-primary", "bg-primary", "text-white");
            // 高對比 outline
            card.style.outline = "3px solid #0d6efd";
            // focusLine: 畫暫時線
            focusLine = {from: card, to: null, letter: c.letter};
            drawLines();
        });
    ...
    shuffledImages.forEach((i, idx) => {
        const card = document.createElement("div");
        card.className = "card text-center shadow-sm p-2 bg-white match-click-target";
        ...
        svgContainer.className = "card-img-top p-3";
        svgContainer.innerHTML = getSVGForLetter(i.letter);

        // 單字
        const cardBody = document.createElement("div");
        cardBody.className = "card-body p-2 d-flex flex-column justify-content-between";
        const wordElem = document.createElement("p");
        wordElem.className = "card-text fw-bold mb-0";
        wordElem.textContent = i.word;
        const letterElem = document.createElement("small");
        letterElem.className = "text-muted";
        ...
        card.addEventListener("click", () => {
            if (matchedLetters.has(i.letter) || !selectedLetter) return;
            if (selectedLetter === i.letter) {
                // 配對成功
                matchedLetters.add(i.letter);
                card.classList.add("bg-secondary", "text-white", "opacity-50");
                card.style.pointerEvents = "none";
                // 左側卡片也變灰
                const leftCards = leftCol.querySelectorAll(".letter-match-card");
                leftCards.forEach(lc => {
                    if (lc.dataset.letter === i.letter) {
                        lc.classList.add("bg-secondary", "text-white", "opacity-50");
                        lc.style.pointerEvents = "none";
                        lc.classList.remove("border-primary", "bg-primary");
                        lc.style.outline = "";
                    }
                });
                // 畫線
                lines.push({from: selectedLetterElem, to: card, letter: i.letter});
                focusLine = null;
                drawLines();
                // 清除選擇
                selectedLetter = null;
                if (selectedLetterElem) selectedLetterElem.classList.remove("border-primary", "bg-primary", "text-white");
                selectedLetterElem = null;
                // 完成提示
                if (matchedLetters.size === group.cards.length) {
                    setTimeout(() => {
                        // WCAG: 用 aria-live 區域提示
                ...
                card.style.boxShadow = "0 0 0 0.25rem rgba(220,53,69,.25)";
                setTimeout(() => {
    ...
    function drawLines() {
        ...
        // 輔助：取得卡片中心點（相對於 centerCol）
        function getCenter(elem) {
            const rect = elem.getBoundingClientRect();
            return {
                x: rect.left + rect.width / 2 - centerRect.left,
    ...
    } // <-- Add this closing brace to end drawLines function
    ...
    spellingSection.className = "bg-light p-4 rounded-3 mb-4";

    const spellingHeader = document.createElement("h2");
    spellingHeader.innerHTML = `<h2 class="fs-1 fw-bold text-indigo mb-5 d-flex align-items-center border-bottom border-indigo-light pb-3">
    <svg class="me-3" style="width: 2.5rem; height: 2.5rem; color: var(--color-indigo-500);" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    group.spellingPractice.words.forEach(word => {
        ...
        shortcutBtn.className = "btn btn-light border text-primary fw-semibold px-3 py-2 rounded-3 shadow-sm";
    ...
    dropArea.className = "bborder border-dashed rounded-3 p-4 mb-4 d-flex flex-wrap align-items-center justify-content-center text-muted text-center fs-6";
    ...
    dropArea.addEventListener("drop", e => {
        ...
        if (letter) addDraggableLetter(letter.toUpperCase());
    });
    ...
    lettersForPool.forEach(letter => {
        ...
        letterDiv.className = "letter-choice d-flex  align-items-center justify-content-center bg-white border rounded-3 px-3 py-2 fw-bold text-dark shadow-sm";
    ...
    function addDraggableLetter(letter) {
        ...
        span.className = "letter-card text-white border-0 rounded-3 d-flex align-items-center justify-content-center px-4 py-3 fw-bold shadow m-2 fs-1";
        ...
        if (dropArea.textContent.includes("拖放字母到此處進行拼字")) {
            dropArea.innerHTML = ""; // clear it once
        }
    ...
    playBtn.className = "btn btn-primary d-flex align-items-center gap-2 px-4 py-2 rounded-3";
    playBtn.innerHTML = `<i class="fas fa-circle-play"></i> 播放發音`;
    ...
    resetBtn.className = "btn btn-secondary d-flex align-items-center gap-2 px-4 py-2 rounded-3";
    resetBtn.innerHTML = `<i class='bi bi-arrow-repeat'></i> 重置拼字`;
    ...
    if (prevGroup) {
        ...
        prevBtn.href = "#";
        prevBtn.className = "btn btn-outline-secondary me-2 mt-4";
        prevBtn.textContent = `上一關：${prevGroup.title}`;
        prevBtn.onclick = e => {
            e.preventDefault();
    ...
    if (nextGroup) {
        ...
        nextBtn.textContent = `下一關：${nextGroup.title}`;
        nextBtn.onclick = e => {
            e.preventDefault();
    ...
    bottomBackBtn.className = "btn btn-link mt-4";
    bottomBackBtn.textContent = "返回首頁";
    bottomBackBtn.onclick = goBackToHome;
    content.appendChild(bottomBackBtn);
}
...
function goBackToHome() {
    // 顯示首頁資訊
    document.getElementById("group-title").textContent = "LadderLessons Phonics";
    document.getElementById("group-description").textContent = "一起學習有趣的字母音素吧！選擇一組開始學習，或從第一組開始冒險！";

    // 顯示組別按鈕與開始按鈕
    document.getElementById("groupList").style.display = "block";
    document.getElementById("startAdventureBtn").style.display = "inline-block";
